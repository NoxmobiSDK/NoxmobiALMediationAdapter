...
Pod::Spec.new do |spec|
  ...
  spec.dependency "AppLovinMediationByteDanceAdapter", "4.0.0.1.0"
  ...
  spec.dependency "AppLovinMediationFacebookAdapter", "6.9.0.1"

  #最近更新
  spec.dependency "AppLovinMediationMintegralAdapter", "7.0.4.0.1"
