Pod::Spec.new do |spec|
  ...
  spec.dependency "AppLovinMediationSmaatoAdapter", "21.6.16.0"


  #最近更新
  spec.dependency "AppLovinMediationGoogleAdapter", "8.10.0.1"
  spec.dependency "AppLovinMediationGoogleAdManagerAdapter", "8.10.0.1"
  spec.dependency "AppLovinMediationFacebookAdapter", "6.6.0.1"
  spec.dependency "AppLovinMediationUnityAdsAdapter", "3.7.5.1"
  spec.dependency "AppLovinMediationVungleAdapter", "6.10.2.0"
  spec.dependency "AppLovinMediationInMobiAdapter", "9.2.1.0"
  spec.dependency "AppLovinMediationByteDanceAdapter", "3.9.0.4.1"
  ...
  spec.dependency "AppLovinMediationFyberAdapter", "7.8.9.0"
